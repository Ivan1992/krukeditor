...
export class EditorComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    //this.KRUK = JSON.parse(""+this.getCookie("kruk"));
    console.log(">>>>AFTER INIT");
    //console.log(this.getCookie("kruk"));
    this.doubleArray = [[]];//this.buildArr(KRUK);
  }

  hoverIn(item) {
    item.clazz = "highlight";
  }
...
/*   add() {
    //this.save();
    KRUK.push(Object.assign({}, KRUK[KRUK.length-1]));
  }

  save() {
    this.putCookie("kruk", JSON.stringify(KRUK));
  }

  status() {
    this.putCookie("kruk", JSON.stringify(KRUK));
    console.log(JSON.stringify(KRUK));
  }

  addContent() : void {
      this.initControls.getEditor()('selection.restore');
      this.initControls.getEditor()('html.insert', 'abc');
  } */
  ...
  public options: Object = {
    ...
    opts = [{label: "Борзая", name: "borzaya", value: false},
            ...
            {label: "Качка", name: "kachka", value: false},
            {label: "Ударка", name: "udarka", value: false},
            {label: "Закидка", name: "zakidka", value: false},
            {label: "Равенство", name: "ravenstvo", value: false},
            {label: "Ломка", name: "lomka", value: false},
            {label: "Подвертка", name: "podvertka", value: false},
            {label: "Отсечка", name: "otsechka", value: false},
            {label: "Задержка", name: "zaderzhka", value: false},
            {label: "Подчашие", name: "podchashie", value: false},
            {label: "Облачко", name: "oblachko", value: false},
            {label: "Сорочья ножка", name: "soroka", value: false},];
}
